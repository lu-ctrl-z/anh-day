    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "fileUpload": {
                    "regex": "none",
                    "alertText": "* File upload không hợp lệ ",
                    "alertText2": "* File upload phải là file có đuôi ",
                    //D2T Start Modify
                    "alertText3": "Chỉ được đính kèm file có định dạng "
                    //D2T End Modify
                },
                "fileUpload2": {
                    "regex": "none",
                ...
                "mobilePhone": {
                    "regex": /^\d+$/,
                    "alertText": "* Hãy nhập số điện thoại (chỉ gồm các chữ số, viết liền)"
                },
                "email": {
                ...
                "number": {
                    ...
                    "alertText": "* Không đúng là số thập phân dạng x.y"
                },
                "date": {
